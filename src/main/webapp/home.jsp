...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/styles/content.css">
	...
	<div class="wrapper">
		...
		<footer>
			<div class="footer-links">
				<a href="#">Reservations</a> | <a href="#">Home</a> | <a href="#">About
					Us</a> | <a href="#">Location</a> | <a href="#">Terms and Condition</a>
			...
			<div class="footer-bottom">
				...
				<div class="footer-socials">
					<a href="https://www.facebook.com/hanzzcedric"> <svg
							height="25px" width="25px" viewBox="0 0 512 512"
					...
					</a> <a href="https://www.instagram.com/hanzcedriccc/"> <svg
							...
							<g transform="matrix(1.01619,0,0,1.01619,44,43.8384)">
								<path
								d="M251.921,0.159C183.503,0.159 174.924,0.449 148.054,1.675C121.24,2.899 102.927,7.157 86.902,13.385C70.336,19.823 56.287,28.437 42.282,42.442C28.277,56.447 
								...
								<path
								d="M251.921,336.053C205.543,336.053 167.947,298.457 167.947,252.08C167.947,205.702 205.543,168.106 251.921,168.106C298.298,168.106 335.894,205.702 335.894,252.08C335.894,298.457 298.298,336.053 
					...
					</a> <a href="#"> <svg id="icons" height="25px" width="25px"
					...
					</a> <a href="#"> <svg height="25px" width="25px"
							viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
								<path fill="white"
